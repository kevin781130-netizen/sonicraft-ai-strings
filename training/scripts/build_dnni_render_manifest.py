...
def main():
    ...
    for i,r in enumerate(plan):
        ...
        capture_vel=float(r['velocity']); vel_verified=bool(r.get('velocity_verified',False)); vel=capture_vel if vel_verified else 0.70
        art=int(r['articulation']); art_verified=bool(r.get('articulation_verified',False))
        rows.append({
            ...
            'velocity':vel, 'capture_velocity':capture_vel, 'velocity_verified':vel_verified,
            'dynamics':0.70, 'expression':0.70,
