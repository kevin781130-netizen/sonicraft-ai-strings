...
COMPILE_TARGETS = (
    ...
    "training/performance_planner_contract.py",
    "training/models/performance_planner.py",
    ...
    "training/smoke_performance_planner_contract.py",
    ...
    "training/scripts/build_performance_planner_dataset.py",
    "training/scripts/apply_performance_planner.py",
...
SMOKE_SCRIPTS = (
    ...
    "smoke_performance_planner_contract.py",
