"""SONICRAFT v6.1 Reproducible Performance Checkpoint compiler.
...
def compile_file(src:Path,out:Path|None=None,policy_path:Path|None=None,round_index:int=1):
    ...
    out=out or src.with_name(src.stem+f"_SONICRAFT_STRINGS_v61_R{round_index}.mid")
    out=Path(out)
    ...
    queue={
        ...
        "purpose":"render A/B/C/D identically, then run v6.1 post-render iteration",
        "slots":{
        ...
        "next_command":"AUTO_LOOP_STRINGS_v61.bat <source score>",
    }
...
def main(argv=None):
    ap=argparse.ArgumentParser(description="SONICRAFT v6.1 Reproducible Performance Checkpoint Strings compiler.")
    ...
    print("SONICRAFT v6.1 Reproducible Performance Checkpoint Compile OK")
