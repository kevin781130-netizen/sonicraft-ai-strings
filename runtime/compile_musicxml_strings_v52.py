"""SONICRAFT v5.2 Global-Coherence-capable A/B/C/D compiler.
...
def compile_file(src:Path,out:Path|None=None,policy_path:Path|None=None,round_index:int=1):
    ...
    out=out or src.with_name(src.stem+f"_SONICRAFT_STRINGS_v52_R{round_index}.mid")
    out=Path(out)
    ...
    queue={
        ...
        "purpose":"render A/B/C/D identically, then run v5.2 post-render iteration",
        "slots":{
        ...
        "next_command":"AUTO_LOOP_STRINGS_v52.bat <source score>",
    }
    ...
    return {
        ...
        "candidate_graphs":candidates,"issues":issues,
    }

def main(argv=None):
    ap=argparse.ArgumentParser(description="SONICRAFT v5.2 Global-Coherence-capable Strings compiler.")
    ...
    print("SONICRAFT v5.2 Shadow Auto-Loop Compile OK")
