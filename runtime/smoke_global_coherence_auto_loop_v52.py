...
with tempfile.TemporaryDirectory() as td:
    ...
    try:
        report,rp=loop.run_auto_loop_v52(score,td/"out",td/"policy.json",port=49591,mock=True,max_round=1,
    ...
    assert Path(row["global_coherence_json"]).exists()
    assert report["final"]["mode"]=="selective_global_guard",report["final"]
    ...
    print("SONICRAFT v5.2 selective + global coherence + merged-vs-D pair verify smoke OK",
          row["coherence_search"],report["final"]["pair_verify"]["overall_delta"],
