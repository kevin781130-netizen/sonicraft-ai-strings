...
import tempfile
import numpy as np
import auto_loop_strings_v53 as loop
...
with tempfile.TemporaryDirectory() as td:
    ...
    try:
        report,rp=loop.run_auto_loop_v53(score,td/"out",td/"policy.json",port=49591,mock=True,max_round=1,
    ...
    print("SONICRAFT v5.3 selective + conductor intent + merged-vs-D pair verify smoke OK",
